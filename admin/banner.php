    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        if(isset($_POST['hbid'])){
            ...
            $title=""; $banner_type_idbanner_type=0; $image_url="";
              $result = mysqli_query($con, "SELECT * FROM page_banner pg  WHERE idpage_banner='$hbid' ");
                            while ($row = mysqli_fetch_array($result)) {
                                $title   = $row['banner_title'];
                                $banner_type_idbanner_type=$row['banner_type_idbanner_type'];
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">Banner</h2>
             ...
             <!-------------------- why choose   section --------------------------------->
                            ...
                            <div class="card-body">
                             ...
                             <div class="table-responsive">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control input-rounded " value="<?php echo $title; ?>"  placeholder="" id="b_title">
                                </div>


                                <h5 style="color:red;margin-top: 20px;">Best image resolution size (Width : 1800px) and (Height : 700px)</h5> 
                                   

                                 <div class="alert alert-success left-icon-big alert-dismissible fade show col-xl-4 col-lg-4" style="float: left;">
                                            
                                    <div class="media"  ondrop="banner_explorer1(event)" ondragover="return false">
                                        <div class="alert-left-icon-big">
                                                <!--    <span><i class="mdi mdi-check-circle-outline"></i></span>-->
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-1 mb-2" style="text-align: center;">Drop file here or</h5>
                                            <div class="btn btn-sm btn-info " onclick="banner_explorer2();">Choose file
                                ...
                                <div class="col-xl-8 col-lg-8 display_none " style="float: left;" id="image_upliader1">
                                        <div class="alert alert-info alert-dismissible fade show" style="padding: 0px;">
                                            <button type="button" class="close"  aria-label="Close" style="background: red;" onclick="banner_uploaded_image_delete();return false;
                                 ...
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                        <?php if($hbid==0){?>
                                        <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="banner_create(1,0);return false;">Add Banner <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <?php }else{?>
                                        <button type="button" id="btn1"  class="btn btn-sm btn-warning " onclick="banner_create(2,<?php echo $hbid; ?>);return false;">Edit Banner Content <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <a class="btn btn-sm btn-primary " href="banner.9web">Reset</a>
                                        <?php }?> 
                                     </div>    
                 ...
                 <div class="col-xl-12"  id="res_banner">
        ...
        <!--== class delete model  -->
          <!-- Modal -->
            <div class="modal fade" id="banner_delete_model">
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Do you want to delete this?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="banner_delete();return false;">Yes</button>
