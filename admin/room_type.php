    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <?php 
        $hrtid=0;
        if(isset($_POST['hrtid'])){
            $hrtid=$_POST['hrtid'];
        }
            $room_type=""; $room_special=""; $room_size=""; $room_view=""; $rooms_count=""; $adults=0; $childern=0;  $rooms_description=""; $image_url=""; $dafault_price=0;
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">Rooms</h2>
                             ...
                             <div class="table-responsive">
                                   ...
                                   <div class="form-group">
                                    ...
                                    <div class="form-group col-xl-6 col-lg-6" style="float: left;">
                                     ...
                                     <div class="form-group">
                                            ...
                                            <input type="number" class="form-control input-rounded " value="<?php echo $dafault_price; ?>"  placeholder="" id="rt_price">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Description</label>
                                                ...
                                                <textarea class="content" name="" id="rtdescription"><?php echo $rooms_description; ?></textarea>
                                                </div>
                                  </div>
                                ...
                                <h5 style="color:red;margin-top: 20px;">Best image resolution size (Width : 700px) and (Height : 500px)</h5> 
                                 ...
                                 <div class="alert alert-success left-icon-big alert-dismissible fade show col-xl-4 col-lg-4" style="float: left;">
                                    ...
                                    <div class="media"  ondrop="room_type_explorer1(event)" ondragover="return false">
                                        <div class="alert-left-icon-big">
                                                <!--    <span><i class="mdi mdi-check-circle-outline"></i></span>-->
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-1 mb-2" style="text-align: center;">Drop file here or</h5>
                                            <div class="btn btn-sm btn-info " onclick="room_type_explorer2();">Choose file
                                ...
                                <div class="col-xl-8 col-lg-8 display_none " style="float: left;" id="image_upliader1">
                                        <div class="alert alert-info alert-dismissible fade show" style="padding: 0px;">
                                            <button type="button" class="close"  aria-label="Close" style="background: red;" onclick="room_type_uploaded_image_delete();return false;
