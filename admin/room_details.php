        ...
        ***********************************-->
        ...
        if(isset($_POST['rid'])){
            ...
            <script type="text/javascript">
             window.location = "room-type.9web";
            </script>
            ';
            // header("location:./room-type.9web");
        }
        ...
        $information="";
        $result = mysqli_query($con, "SELECT * FROM room_information   WHERE  rooms_suites_idrooms_suites='$hrid' ");
                            while ($row = mysqli_fetch_array($result)) {
                                $idroom_information   = $row['idroom_information'];
             ...
             <!-------------------- why choose   section --------------------------------->
                 ...
                 <div class="col-xl-6 col-lg-6" >
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                             ...
                             <div class="table-responsive">
                                ...
                                <h5 style="color:red;margin-top: 20px;">Best image resolution size (Width : 700px) and (Height : 500px)</h5> 
                  ...
                  <div class="col-xl-6 col-lg-6" >
                    ...
                    <div class="card">
                            ...
                            <div class="card-body">
                                   ...
                                   <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-rounded " value="<?php echo $information; ?>"  placeholder="" id="amenities">
                                    </div>


                                    <div class="col-xl-12 col-lg-12 " style="float: left;" >

                                         <button type="button" name="1"  class="btn btn-sm btn-info " id="btn1" onclick="rooms_amenities(this.name);return false;">Add Amenities <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Rooms Amenities List </h4>
                            </div>
                            <div class="card-body" >
                              <div id="res_amenities"><?php echo room_amenities_list($con,$rid);?></div>
        ...
        <!--== class delete model  -->
          <!-- Modal -->
            <div class="modal fade" id="room_image_delete_model">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Delete Room Image</h5>
                            <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                        </div>
                        <div class="modal-body">Do you want to delete this?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="room_image_delete();return false;">Yes</button>
        ...
        <!-- == class delete model end -->
         ...
         <!--== class delete model  -->
          <!-- Modal -->
            <div class="modal fade" id="room_amenities_delete_model">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">Do you want to delete this?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="rooms_amenitie_delete();return false;">Yes</button>
                                <button type="button" class="btn btn-default light" data-dismiss="modal">No</button>
