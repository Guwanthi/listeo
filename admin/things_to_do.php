...
<head>
    ...
    <title>9-WEB Things To Do</title>
    <!-- Favicon icon -->
    ...
    ***********************************-->
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        <?php 
        $httdid=0;
        if(isset($_POST['httdid'])){
            $httdid=$_POST['httdid'];
        }
            $title=""; $description=""; $image_url=""; $img_alt="";
              $result = mysqli_query($con, "SELECT * FROM things_to_do  WHERE id_things_to_do='$httdid' ");
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">Things To Do</h2>
             ...
             <!-------------------- why choose   section --------------------------------->
                            ...
                            <div class="card-body">
                             ...
                             <div class="table-responsive">
                                   ...
                                   <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" class="form-control input-rounded " value="<?php echo $title; ?>"  placeholder="" id="title">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Description</label>
                                                ...
                                                <textarea class="content" name="" id="description"><?php echo $description; ?></textarea>
                                                </div>
                                  </div>
                                 ...
                                 <div class="alert alert-success left-icon-big alert-dismissible fade show col-xl-4 col-lg-4" style="float: left;">
                                    ...
                                    <div class="media"  ondrop="place_explorer1(event)" ondragover="return false">
                                        <div class="alert-left-icon-big">
                                                <!--    <span><i class="mdi mdi-check-circle-outline"></i></span>-->
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-1 mb-2" style="text-align: center;">Drop file here or</h5>
                                            <div class="btn btn-sm btn-info " onclick="place_explorer2();">Choose file
                                ...
                                <div class="col-xl-8 col-lg-8 display_none " style="float: left;" id="image_upliader1">
                                        <div class="alert alert-info alert-dismissible fade show" style="padding: 0px;">
                                            <button type="button" class="close"  aria-label="Close" style="background: red;" onclick="place_uploaded_image_delete();return false;
                                 ...
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                        <?php if($httdid==0){?>
                                        <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="place_create(1,0);return false;">Create <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <?php }else{?>
                                        <button type="button" id="btn1"  class="btn btn-sm btn-warning " onclick="place_create(2,<?php echo $httdid; ?>);return false;">Edit  <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <a class="btn btn-sm btn-primary " href="things-to-do.9web">Reset</a>
                                        <?php }?> 
                                     </div>    
                 ...
                 <div class="col-xl-12"  id="res_place">
        ...
        <!--== class delete model  -->
          <!-- Modal -->
            <div class="modal fade" id="place_delete_model">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Delete Things To Do</h5>
                            <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                        </div>
                        <div class="modal-body">Do you want to delete this?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="place_delete();return false;">Yes</button>
