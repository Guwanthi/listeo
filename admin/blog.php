            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">Blog</h2>
                            ...
                            <div class="card-body">
                             ...
                             <div class="table-responsive">
                                   ...
                                   <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-rounded " value="<?php echo $title; ?>"  placeholder="" id="bl_title">
                                    </div>
                                ...
                                <div class="col-xl-8 col-lg-8 display_none " style="float: left;" id="image_upliader1">
                                 ...
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                        <?php if($hbid==0){?>
                                        <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="blog_create(1,0);return false;">Add Blog Content <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <?php }else{?>
                                        <button type="button" id="btn1"  class="btn btn-sm btn-warning " onclick="blog_create(2,<?php echo $hbid; ?>);return false;">Edit Blog Content <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <a class="btn btn-sm btn-primary " href="blog.9web">Reset</a>
                                        <?php }?> 
                                     </div>    
                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">Do you want to delete this?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="blog_delete();return false;">Yes</button>
