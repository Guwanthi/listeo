...
<head>
    ...
    <title>9-WEB Terms and conditions</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">Terms and conditions</h2>
                             ...
                             <div class="table-responsive">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Terms and conditions</label>
                                                ...
                                                <textarea class="content" name="" id="tnc"><?php echo  $conditions; ?></textarea>
                                                </div>
                                  </div>

                              
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                          <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="tnc_save();return false;">Add <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                </div>    
