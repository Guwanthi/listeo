    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        if(isset($_POST['hwcid'])){
           ...
           $result = mysqli_query($con, "SELECT * FROM why_choose WHERE idwhy_choose='$hwcid'  ");
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">Why Choose </h2>
             ...
             <!-------------------- why choose   section --------------------------------->
                            ...
                            <div class="card-body">
                             ...
                             <div class="table-responsive">
                                   ...
                                   <div class="form-group">
                                            <label>Title</label>
                                            <input type="text" class="form-control input-rounded " value="<?php echo $title; ?>"  placeholder="" id="wc_title">
                                    </div>
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Description</label>
                                                ...
                                                <textarea class="content" name="" id="wcdescription"><?php echo $description; ?></textarea>
                                    </div>
                                </div>
                                 ...
                                 <div class="alert alert-success left-icon-big alert-dismissible fade show col-xl-4 col-lg-4" style="float: left;">
                                    ...
                                    <div class="media"  ondrop="why_choose_explorer1(event)" ondragover="return false">
                                        <div class="alert-left-icon-big">
                                                
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-1 mb-2" style="text-align: center;">Drop file here or</h5>
                                            <div class="btn btn-sm btn-info " onclick="why_choose_explorer2();">Choose file
                                ...
                                <div class="col-xl-8 col-lg-8 display_none " style="float: left;" id="image_upliader1">
                                        <div class="alert alert-info alert-dismissible fade show" style="padding: 0px;">
                                            <button type="button" class="close"  aria-label="Close" style="background: red;" onclick="why_choose_uploaded_image_delete();return false;
                                 ...
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                        <?php if($hwcid==0){?>
                                        <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="why_choose_create(1,0);return false;">Add Content <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <?php }else{?>
                                        <button type="button" id="btn1"  class="btn btn-sm btn-warning " onclick="why_choose_create(2,<?php echo $hwcid; ?>);return false;">Edit Content <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <a class="btn btn-sm btn-primary " href="why-choose.9web">Reset</a>
                                        <?php }?> 
                                     </div>    
                 ...
                 <div class="col-xl-12"  id="res_why_choose" >

                    <?php why_choose_slider($con); ?>
        ...
        <!--== class delete model  -->
          <!-- Modal -->
            <div class="modal fade" id="wc_delete_model">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Delete Why Choose</h5>
                            <button type="button" class="close" data-dismiss="modal"><span>&times;</span></button>
                        </div>
                        <div class="modal-body">Do you want to delete this?</div>
                            <div class="modal-footer">
                                <button type="button" class="btn btn-danger" data-dismiss="modal" onclick="why_choose_delete();return false;">Yes</button>
