...
<head>
    ...
    <title>9-WEB Tour Details</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1"><?php echo $package_title;?> Tour Details </h2>
             ...
             <!-------------------- why choose   section --------------------------------->
                  <div class="col-xl-12 col-lg-12" >
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h4 class="card-title"><?php echo $package_title;?> Include</h4>
                            </div>
                            <div class="card-body">
                                  ...
                                  <div class="col-xl-4 col-lg-4"  style="float:left;">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Includes</label>
                                        <div class="page-wrapper box-content">
                                            <textarea class="content" name="" id="idescription"><?php echo $included; ?></textarea>
                                        </div>
                                    </div>
                                 ...
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                     <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="tour_include_update(<?php echo $htid; ?>);return false;">Add Tour Include <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>          
                                 </div>    
                                ...
                                <div class="col-xl-4 col-lg-4"  style="float:left;">
                                 ...
                                 <div class="form-group">
                                        <label class="form-control-label">Tour Exclude</label>
                                        <div class="page-wrapper box-content">
                                            <textarea class="content2" name="" id="edescription"><?php echo $excluded; ?></textarea>
                                        </div>
                                    </div>

                                <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                     <button type="button"  class="btn btn-sm btn-info " id="btn2" onclick="tour_exclude_update(<?php echo $htid; ?>);return false;">Add Tour Exclude <img src="images/loading.gif" id="btn_loading2" class="loading_img display_none"></button>          
                                 </div>  
                                ...
                                <div class="col-xl-4 col-lg-4"  style="float:left;">
                                 ...
                                 <div class="form-group">
                                        <label class="form-control-label">Tour Special Offers</label>
                                        <div class="page-wrapper box-content">
                                            <textarea class="content3" name="" id="tspecial_offer"><?php echo $special_offers; ?></textarea>
                                        </div>
                                    </div>

                                <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                     <button type="button"  class="btn btn-sm btn-info " id="btn3" onclick="tour_special_offers(<?php echo $htid; ?>);return false;">Add Special Offers <img src="images/loading.gif" id="btn_loading2" class="loading_img display_none"></button>          
                                 </div>  
                                 ...
                                 <div class="col-xl-6 col-lg-6"  style="float:left;">
                                   ...
                                   <div class="card-header">
                                    <h4 class="card-title"><?php echo $package_title;?> Images</h4>
                                   </div> 

                                     <div class="form-group">
                                            <label>Image Keywords</label>
                                            <input type="text" class="form-control input-rounded " value=""   id="img_alt">
                                    </div>  
                                 ...
                                 <div class="alert alert-success left-icon-big alert-dismissible fade show col-xl-4 col-lg-4" style="float: left;">
                                    ...
                                    <div class="media"  ondrop="tour_package_explorer1(event)" ondragover="return false">
                                        <div class="alert-left-icon-big">
                                                <!--    <span><i class="mdi mdi-check-circle-outline"></i></span>-->
                                        </div>
                                        <div class="media-body">
                                            <h5 class="mt-1 mb-2" style="text-align: center;">Drop file here or</h5>
                                            <div class="btn btn-sm btn-info " onclick="tour_package_explorer2();">Choose file
                 ...
                 <div class="col-xl-12"  id="res_tour_package_ig">
                    ...
                    <?php tour_package_image_gallery($con,$htid); ?>
