    ...
    <div id="main-wrapper">
        ...
        ***********************************-->
        ...
        if(isset($_POST['hsid'])){
            ...
            $services_title="";   $image_url=""; $surl="";
              $result = mysqli_query($con, "SELECT * FROM services WHERE idservices='$hsid'  ");
                            while ($row = mysqli_fetch_array($result)) {
                                $idabout_special_things     = $row['idabout_special_things'];
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">About</h2>
                            ...
                            <div class="card-body">
                             ...
                             <div class="table-responsive">
                                   ...
                                   <div class="form-group">
                                            ...
                                            <input type="text" class="form-control input-rounded " value="<?php echo $services_title; ?>"  placeholder="" id="st_title">
                                    </div>

                                       <div class="form-group">
                                            <label>Services URL</label>
                                            <input type="text" class="form-control input-rounded " value="<?php echo $surl; ?>"  placeholder="" id="s_url">
                                    </div>
                                ...
                                <div class="col-xl-8 col-lg-8 display_none " style="float: left;" id="image_upliader1">
                                 ...
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                        <?php if($hsid==0){?>
                                        <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="services_type(1,0);return false;">Add Services <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <?php }else{?>
                                        <button type="button" id="btn1"  class="btn btn-sm btn-warning " onclick="services_type(2,<?php echo $hsid; ?>);return false;">Edit Services <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                        <a class="btn btn-sm btn-primary " href="about.9web">Reset</a>
                                        <?php }?> 
                                     </div>    
