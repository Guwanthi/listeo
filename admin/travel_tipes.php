...
<head>
    ...
    <title>9-WEB Travel Tipes</title>
    <!-- Favicon icon -->
            ...
            <div class="container-fluid">
                ...
                <div class="form-head d-flex mb-0 mb-lg-4 align-items-start">
                    <div class="mr-auto d-none d-lg-block">
                        <h2 class="text-black font-w600 mb-1">Travel Tipes</h2>
                  ...
                  <div class="col-xl-12 col-lg-12" >
                    ...
                    <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">Travel Tipes</h4>
                            </div>
                            <div class="card-body">
                             ...
                             <div class="table-responsive">
                                    ...
                                    <div class="form-group">
                                        <label class="form-control-label">Travel Tipes</label>
                                                <div class="page-wrapper box-content">
                                                <textarea class="content" name="" id="tipes"><?php echo  $tipes; ?></textarea>
                                                </div>
                                  </div>

                              
                                 <div class="col-xl-12 col-lg-12 " style="float: left;" >
                                          <button type="button"  class="btn btn-sm btn-info " id="btn1" onclick="travel_tipes_save();return false;">Add <img src="images/loading.gif" id="btn_loading1" class="loading_img display_none"></button>
                                </div>    
